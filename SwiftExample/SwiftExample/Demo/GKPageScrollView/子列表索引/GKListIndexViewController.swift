//
//  GKListIndexViewController.swift
//  GKPageScrollViewSwift
//
//  Created by QuintGao on 2019/3/14.
...
class GKListIndexViewController: GKDemoBaseViewController {
...
extension GKListIndexViewController: GKPageScrollViewDelegate {
    ...
    func pageScrollView(_ pageScrollView: GKPageScrollView, initListAtIndex index: Int) -> GKPageListViewDelegate {
        GKIndexListViewController()
    }
}

extension GKListIndexViewController: JXSegmentedViewDelegate {
