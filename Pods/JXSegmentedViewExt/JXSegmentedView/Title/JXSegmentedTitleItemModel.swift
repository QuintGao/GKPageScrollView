...
public enum JXSegmentedTitleLabelAnchorPointStyle {
    case center
    case top
    case bottom
}
...
open class JXSegmentedTitleItemModel: JXSegmentedBaseItemModel {
    ...
    open var titleLabelVerticalOffset: CGFloat = 0
    ...
    open var titleZoomSelectedVerticalOffset: CGFloat = 0
    ...
    open var titleLabelAnchorPointStyle = JXSegmentedTitleLabelAnchorPointStyle.center
}
